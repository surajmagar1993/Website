    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight">Manage Services</h1>
            <p className="text-sm text-[var(--color-text-secondary)] mt-1">Add, edit, or remove services. These appear on the homepage and individual service pages.</p>
          </div>
          <button 
            onClick={() => openModal()}
