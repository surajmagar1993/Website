    ...
    <div className="min-h-screen bg-[var(--color-bg)] p-8">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={closeModal}>
            <div className="bg-[var(--color-surface)] border border-white/10 rounded-2xl w-full max-w-lg h-full md:h-auto md:max-h-[90vh] overflow-hidden shadow-2xl flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 border-t border-white/10 flex justify-end gap-3 bg-black/20 flex-shrink-0">
                    <button 
                        onClick={closeModal}
