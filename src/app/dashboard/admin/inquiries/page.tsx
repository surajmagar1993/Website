    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div>
            ...
            <p className="text-[var(--color-text-secondary)] mt-1 text-sm">Customer contact form submissions</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="glass border-white/10 bg-black/20 text-white">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Total Inquiries</CardTitle>
          ...
          <Card className="glass border-white/10 bg-black/20 text-white">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-400">{inquiries.filter(i => i.status === 'read').length}</div>
              <p className="text-xs text-gray-500 mt-1">Marked as read</p>
            </CardContent>
          </Card>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[calc(100vh-340px)]">
            {/* List */}
