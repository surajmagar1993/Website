...
const defaultValueProps: ValueProp[] = [
  {
    ...
    description:
      "We don't just build software — we understand your business. Complete strategy to ongoing support.",
  },
  {
    icon: "BarChart3",
    title: "Results, Not Just Deliverables",
    description:
      "Your success is our metric. We focus on outcomes: revenue, efficiency, and lasting competitive advantages.",
  },
  {
    icon: "Handshake",
    title: "Transparent & Agile",
    description:
      "No tech jargon, no surprises. Clear communication and regular updates every step of the way.",
  },
];
...
const defaultProcessSteps: ProcessStep[] = [
  ...
  },
  {
    step: 2,
    title: "Strategy",
    description: "Design roadmap tailored to your objectives & budget",
  },
  {
    step: 3,
    title: "Development",
    description: "Build with precision, regular updates & milestones",
  },
  {
    step: 4,
    title: "Launch & Support",
    description: "Go live with training, monitoring & ongoing support",
  },
];
...
export default async function HomePage() {
  ...
  return (
    <>
      {/* ═══ SECTION 1: HERO ═══ */}
      <section className="min-h-[100dvh] md:min-h-screen flex flex-col justify-center relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10 pt-28 sm:pt-32 pb-16 sm:pb-20">
          <div className="max-w-4xl text-center mx-auto">
            <h1 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-[900] text-white leading-tight mb-6 sm:mb-8 tracking-tighter flex flex-col items-center justify-center w-full whitespace-nowrap">
              ...
              <HyperText
                text={
                  settings.home_hero_title_suffix || "Technology That Works."
                }
                className="glow-text mt-2 px-2 text-center w-full text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-[family-name:var(--font-heading)] font-[900]"
              />
            </h1>

            <FadeIn delay={0.6}>
              <p className="text-[var(--color-text-secondary)] text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed px-2">
                {settings.home_hero_subtitle ||
                  "From custom software to data-driven insights, we build digital solutions that drive real results for ambitious businesses across India and beyond."}
              </p>
            </FadeIn>
            ...
            >
              <Link
                href={settings.home_hero_cta_link || "/contact"}
                className="btn-primary inline-flex items-center gap-2 justify-center group"
              >
                {settings.home_hero_cta_text || "Get Free Consultation"}{" "}
                <ArrowRight
                  size={18}
              ...
              <Link
                href="/work"
                className="btn-outline inline-flex items-center gap-2 justify-center group"
              >
                View Our Work{" "}
                <ArrowRight
                  size={18}
            ...
            <FadeIn delay={1.0}>
              <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mt-16 pt-8 border-t border-[var(--color-glass-border)]">
                {trustBadges.map((badge) => (
                  <div
                    key={badge.label}
                    className="flex items-center gap-2 md:gap-3 text-[var(--color-text-secondary)]"
                  >
                    <span className="text-[var(--color-primary)]">
                      {badge.icon}
                    </span>
                    <div className="flex flex-col md:flex-row md:items-center md:gap-2 leading-tight">
                      <span className="font-[family-name:var(--font-heading)] font-bold text-white text-base md:text-lg">
                        {badge.value}
                      </span>
        ...
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-white">
              {settings.section_value_prop_heading ||
                "Why Growing Businesses Choose Genesoft"}
            </h2>
          </FadeIn>
      ...
      <section className="py-24 relative bg-black/20">
        <ParallaxOrb
          speed={0.4}
          className="orb orb-orange w-[300px] h-[300px] top-[10%] right-[-10%]"
        />
        ...
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-white">
              {settings.section_services_heading ||
                "Solutions Built for Your Growth"}
            </h2>
            <p className="text-[var(--color-text-secondary)] text-lg max-w-2xl mx-auto mt-4">
              Whether you need digital presence, custom software, or data
              insights — we have the expertise to make it happen
            </p>
          </FadeIn>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {!services || services.length === 0 ? (
              <div className="col-span-full text-center text-[var(--color-text-muted)] py-12 border border-dashed border-white/10 rounded-xl">
                <p>
                  Services not yet configured. Please add them in the Admin
                  Dashboard.
                </p>
              </div>
            ) : (
      ...
      <section className="py-24 relative">
        <ParallaxOrb
          speed={-0.2}
          className="orb orb-blue w-[300px] h-[300px] top-[20%] left-[-5%]"
        />
        ...
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-white">
              {settings.section_process_heading ||
      ...
      <section className="py-24 border-y border-[var(--color-glass-border)] relative overflow-hidden">
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-12">
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-white">
              {settings.section_social_proof_heading ||
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <FadeIn className="max-w-2xl">
              ...
              <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold mt-3 text-white leading-[1.1]">
                {settings.section_portfolio_heading ||
                  "Success Stories We've Built Together"}
              </h2>
            </FadeIn>
            <FadeIn direction="left" delay={0.2}>
              <Link
                href="/work"
                className="flex items-center gap-2 text-[var(--color-primary)] hover:text-white transition-colors pb-2 border-b border-[var(--color-primary)]/30 hover:border-white"
              >
      ...
      <section className="py-32 relative overflow-hidden">
        <ParallaxOrb
          speed={0.6}
          className="orb orb-orange w-[400px] h-[400px] top-[-20%] left-[20%]"
        />
        <ParallaxOrb
          speed={-0.4}
          className="orb orb-blue w-[300px] h-[300px] bottom-[-20%] right-[10%]"
        />
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <FadeIn direction="up">
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              {settings.section_cta_heading || (
                <>
                  Ready to{" "}
                  <span className="glow-text">Transform Your Business?</span>
                </>
              )}
            </h2>
            <p className="text-[var(--color-text-secondary)] text-lg max-w-xl mx-auto mb-10">
              {settings.section_cta_subtitle ||
                "Let\u2019s discuss how technology can solve your biggest challenges and unlock new opportunities"}
            </p>
            <Link
              href="/contact"
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 mt-12 text-[var(--color-text-secondary)]">
              <a
                href={`tel:${settings.contact_phone || "+918888885285"}`}
                className="flex items-center gap-2 hover:text-white transition-colors"
              >
                <Phone size={18} className="text-[var(--color-primary)]" />
                <span className="text-sm">
                  {settings.contact_phone || "+91 88888 85285"}
                </span>
              </a>
              <a
                href={`mailto:${settings.contact_email || "info@genesoftinfotech.com"}`}
                className="flex items-center gap-2 hover:text-white transition-colors"
              >
