                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-white/5 border-b border-white/5">
                            ...
                            <th className="p-3 text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider">Asset ID / Serial</th>
                                ...
                                <tr key={product.id} className="group hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-3">
                                        <div className="flex flex-col">
                                            {product.asset_id && <span className="text-[var(--color-primary)] font-bold text-xs">{product.asset_id}</span>}
                                            <span className="text-sm font-mono text-[var(--color-text-muted)]">{product.serial_number}</span>
                                        </div>
                                    </td>
